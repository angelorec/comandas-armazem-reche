  ...
  app.get('/api/supabase/additionals', async (req, res) => {
    try {
      ...
      res.json([
        ...
        { id: 2003, nome: 'Chuleta de Contrafilé (Marmitex/Lá Minuta)', preco: 3.00, categoria_id: 1 },
        { id: 2004, nome: 'Bife de Lentilha à Parmegiana (Marmitex/Lá Minuta)', preco: 2.00, categoria_id: 1 },
        { id: 2005, nome: 'Bife de Coxão Mole Acebolado (Marmitex/Lá Minuta)', preco: 3.00, categoria_id: 1 },
        { id: 2006, nome: 'Chuleta de Contrafilé Acebolada (Marmitex/Lá Minuta)', preco: 5.00, categoria_id: 1 },
        { id: 2007, nome: 'Bife de Lentilha (Vegetariano) (Marmitex/Lá Minuta)', preco: 0.00, categoria_id: 1 },
        { id: 2008, nome: 'Filé de Frango Grelhado (Marmitex/Lá Minuta)', preco: 0.00, categoria_id: 1 },
        { id: 2009, nome: 'Adicional Bife de Coxão Mole Precoce', preco: 14.00, categoria_id: 2 },
        { id: 2010, nome: 'Adicional Filé de Frango à Parmegiana', preco: 14.00, categoria_id: 2 },
        { id: 2011, nome: 'Adicional Chuleta de Contrafilé', preco: 16.00, categoria_id: 2 },
        { id: 2012, nome: 'Adicional Bife de Coxão Mole Acebolado', preco: 17.05, categoria_id: 2 },
        { id: 2013, nome: 'Adicional Chuleta de Contrafilé Acebolada', preco: 17.05, categoria_id: 2 },
        { id: 2014, nome: 'Adicional Bife de Lentilha à Parmegiana', preco: 14.00, categoria_id: 2 },
        { id: 2015, nome: 'Adicional Filé de Frango Grelhado', preco: 14.00, categoria_id: 2 },
        { id: 2016, nome: 'Adicional Ovo Frito', preco: 5.00, categoria_id: 3 },
        { id: 2017, nome: 'Talheres Descartáveis', preco: 0.00, categoria_id: 3 },
        { id: 2018, nome: 'Bolo de Prestígio Caseiro', preco: 12.00, categoria_id: 4 },
        { id: 2019, nome: 'Bolo Dois Amores', preco: 12.00, categoria_id: 4 },
        { id: 2020, nome: 'Pudim Caseiro', preco: 13.00, categoria_id: 4 },
        { id: 2021, nome: 'Paçoquinha', preco: 1.50, categoria_id: 4 },
        { id: 2022, nome: 'Geleia (Sinaleira de Monza)', preco: 1.50, categoria_id: 4 },
        { id: 2023, nome: 'Pé de Moça', preco: 3.50, categoria_id: 4 },
        { id: 2024, nome: 'Gibi', preco: 1.50, categoria_id: 4 },
        { id: 2025, nome: 'Pastel: Queijo', preco: 6.00, categoria_id: 3 },
        { id: 2026, nome: 'Pastel: Palmito', preco: 6.00, categoria_id: 3 },
        { id: 2027, nome: 'Pastel: Ovo', preco: 7.00, categoria_id: 3 },
        { id: 2028, nome: 'Pastel: Milho', preco: 5.00, categoria_id: 3 },
        { id: 2029, nome: 'Pastel: Ervilha', preco: 5.00, categoria_id: 3 },
        { id: 2030, nome: 'Pastel: Cheddar', preco: 7.00, categoria_id: 8 },
        { id: 2031, nome: 'Pastel: Catupiry', preco: 7.00, categoria_id: 8 },
        { id: 2032, nome: 'Pastel: Calabresa', preco: 7.00, categoria_id: 3 },
        { id: 2033, nome: 'Pastel: Brócolis', preco: 6.00, categoria_id: 3 },
        { id: 2034, nome: 'Pastel: Bacon', preco: 7.00, categoria_id: 3 },
        { id: 2035, nome: 'Pastel: Azeitona', preco: 5.00, categoria_id: 3 },
        { id: 2036, nome: 'Pastel: Tomate', preco: 5.00, categoria_id: 3 }
      ]);
    }
  });
